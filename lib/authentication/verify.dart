      ...
      body: Stack(
        children: [
          Container(
            ...
            color: const Color(0xFFFFFF).withOpacity(1.0),
          ),
          Align(
              ...
              child: Column(
                children: [
                  ...
                  GradientText('SoftLocker',
                      ...
                      colors: [
                        const Color(0x2B2A7B).withOpacity(1.0),
                        const Color(0x0071A5).withOpacity(1.0),
                      ]),
                  const SizedBox(
                    height: 50,
                  ),
                  ...
                  Container(
                    ...
                    height: 56,
                    decoration: BoxDecoration(
                      color: const Color(0x0D4671).withOpacity(1.0),
                      ...
                      children: [
                        Align(
                          ...
                          child: Container(
                            ...
                            alignment: Alignment.centerLeft,
                            decoration: BoxDecoration(
                              color: const Color(0xFFF5F5).withOpacity(1.0),
                              borderRadius: BorderRadius.circular(19),
                            ),
                            child: TextField(
                  ...
                  ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      foregroundColor:
                          const Color.fromARGB(0, 0, 0, 0).withOpacity(1.0),
                      backgroundColor: const Color(0x92E1E2).withOpacity(1.0),
